 ...
 *
 * This layout is used when displaying the comments summary in the tag article view.
 *
 * Override by creating the folder templates/YOUR_TEMPLATE/html/layouts/akeeba/engage/content and copying this file in
 * there. That file will be used instead of the file plugins/content/engage/layouts/akeeba/engage/content/tag.php
 *
...
?>
<aside class="akenage-comments-counter--tag">
	<a href="<?= $uri->toString() ?>">
